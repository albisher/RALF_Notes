**Tags:** #API, #Validation, #Card Management, #Sequential Processing, #Modular Design
**Created:** 2026-01-13
**Type:** code-notes
...
Orchestrates operation execution, validates inputs, and routes requests to the API client.

### ``list()``

Retrieves cards from a specified world with optional filters.
...
Adds a new card with provided data.

### ``update()``

Modifies an existing card using its ID and update payload.
