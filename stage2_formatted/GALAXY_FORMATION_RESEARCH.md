**Tags:** #procedural-generation, #2d-visualization, #astronomy, #fast-algorithms, #deterministic-simulation
**Created:** 2026-01-13
**Type:** code-notes
...
### `generate_spiral_arms`

Creates spiral arm patterns using hash-based parameters for deterministic generation.

### `generate_galactic_core`

Produces a central Gaussian density core around the map center.

### `generate_galaxy_map`

Combines spiral arms and core into a single density map with core precedence.

### `generate_galaxy_fast`

Optimized grid-based method for ultra-low-resolution (64x64) maps.
...
- [[Map Generation Path - World Type: Galaxy]]
- [[World Type: Galaxy]]
