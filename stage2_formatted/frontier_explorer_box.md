**Tags:** #autonomous_exploration, #voxel_grid, #frontier_detection, #path_planning, #robotics
**Created:** 2026-01-13
**Type:** code-notes
...
Initializes the explorer with configurable voxel resolution, frontier size thresholds, and max frontier tracking.

### ``detect_frontiers``

Scans the occupancy map for frontier voxels (occupied with at least one empty neighbor in 26-connected space), clusters them, and computes metrics for each frontier. Returns a list of frontier dictionaries.
