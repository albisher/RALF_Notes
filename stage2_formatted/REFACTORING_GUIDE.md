**Tags:** #refactoring, #vuejs, #composables, #component-extraction, #code-organization
**Created:** 2026-01-13
**Type:** documentation
...
Manages world loading, creation, and settings.

### `useTimelineOperations.js`

Handles timeline operations (top/side timelines, markers).

### `useCardOperations.js`

Handles card loading, filtering, and selection.

### `useMapOperations.js`

Performs coordinate calculations and rendering.

### `useWorkflowStages.js`

Manages workflow stages and navigation.

### `CardViewHeader.vue`

Extracted reusable header component for CardViewPage.

### `CardViewSection.vue`

Created for modular section rendering in WorkflowPage.

### `CardMapViewer.vue`

Potential component for map visualization (needs integration).
...
> `Vuex (if applicable)`
> `Composition API`
> `UI-beta project dependencies (e.g.`
> ``processed_map.json``
> ``cards-data.js`).`
