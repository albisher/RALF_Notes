**Tags:** #system-monitoring, #cli-tool, #health-check, #docker, #webapp-status
**Created:** 2026-01-13
**Type:** code-notes
...
Main script that orchestrates API, Docker, and system state checks.

### `API Health Check`

Retrieves and displays API status, running state, and simulation time.

### `System State Check`

Collects drone count, building count, mission state, and session status.

### `Docker Container Inspection`

Lists and verifies the status of all Docker containers in the system.
...
> `Python 3`
> `Docker CLI`
> `HTTP requests library (likely `requests` or similar for API calls).`
