**Tags:** #SSL, #Certbot, #Nginx, #Docker, #Automation
**Created:** 2026-01-13
**Type:** code-notes
...
Renews SSL certificates using Certbot with a webroot path for automatic file generation.

### `docker-compose exec proxy nginx -s reload`

Reloads Nginx configuration to apply updated SSL certificates without downtime.
