**Tags:** #database-model, #flask-sqlalchemy, #world-building, #jsonb-storage, #time-tracking
**Created:** 2026-01-13
**Type:** code-notes
...
Manages user accounts with WebAuthn credentials and links to their worlds/preferences.

### `World`

Core entity representing a virtual space (e.g., planet, colony) with hierarchical parent-child relationships.

### `WorldElement`

Stores generated content (e.g., characters, buildings) tied to a world and user.

### `Timeline`

Tracks historical/story events across worlds, with flexible date formats and metadata.

### `TimelineEvent`

Individual events within a timeline, linked to specific worlds and dates.
