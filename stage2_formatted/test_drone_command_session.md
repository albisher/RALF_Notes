**Tags:** #testing, #drone, #api-integration, #session-management, #automation
**Created:** 2026-01-12
**Type:** code-notes
...
Initializes session with base URL, session ID, drone name, and tracking lists.

### ``log_issue``

Records API failures or errors.
...
Executes HTTP requests (GET/POST) and validates responses, returning parsed JSON or raw text.

### ``test_1_check_server``

Verifies server health via `/api/health` endpoint.
...
- [[drone_api_specification]]
- [[drone_simulation_setup]]
