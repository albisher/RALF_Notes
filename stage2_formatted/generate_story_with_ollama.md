**Tags:** #story-generation, #world-building, #ollama-integration, #backend-api, #python-requests
**Created:** 2026-01-13
**Type:** code-script
...
Logs in with default credentials to obtain an authentication token.

### `create_world_with_assets(token)`

Builds a virtual world with predefined characters, buildings, and robots using the token.

### `generate_ollama_story(world_id, headers)`

Queries world details, constructs a prompt from elements, and delegates story generation to Ollama’s API.
...
- [[Backend World Creation Endpoint]]
