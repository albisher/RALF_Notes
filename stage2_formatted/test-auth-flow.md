**Tags:** #authentication-test, #puppeteer, #web-scraping, #api-interaction, #cyberpunk-demo
**Created:** 2026-01-13
**Type:** test-reference
...
Orchestrates the entire authentication flow, including frontend loading, API monitoring, and manual login testing.

### `puppeteer.launch`

Configures and starts a headless browser with security-disabling flags (for testing only).

### `page.on('request')/**page.on('response')`

Intercepts and logs API calls/responses for analysis.

### `page.evaluate()`

Executes JavaScript in the browser context to simulate manual login and fetch tokenized data.
