**Tags:** #Puppeteer, #AutomatedTesting, #NodeJS, #ConcurrencyControl, #ErrorHandling, #Logging, #ScriptExecution
**Created:** 2026-01-13
**Type:** code-notes

# run-all-puppeteer-sessions
...
Orchestrates session execution, logging, and result aggregation.

### ``execSync()``

Executes each Puppeteer script synchronously with error handling.

### ``fs.existsSync()`/`readdirSync()``

Validates screenshot directories and counts saved files.
...
- [[Puppeteer Session Documentation]]
- [[Node]]
