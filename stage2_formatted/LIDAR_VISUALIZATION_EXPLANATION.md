**Tags:** #LiDAR, #Drone, #Visualization, #Ground_Plane, #Data_Processing
**Created:** 2026-01-13
**Type:** documentation
...
Circular dots representing LiDAR rays hitting the ground below the drone.

### `Drone flight path`

Red dashed line showing the drone’s trajectory.

### `Ground truth objects`

Black outlined shapes indicating predefined objects in the environment.

### `LiDAR points on objects`

Purple dots at object heights where LiDAR rays intersect them.

### `Telemetry packet storage`

Ensures all LiDAR points are saved in telemetry logs.

### `Visualization debugging`

Checks for missing LiDAR data in logs and console output.
